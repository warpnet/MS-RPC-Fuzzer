        ...
        foreach ($interfaceEntry in $interfaces) {
            ...
            foreach ($stringbinding in $stringBindings) {
                ...
                if ($Procedure) {
                    ...
                    $methods = $Client.GetType().GetMethods() | Where-Object { $_.IsPublic -and $_.DeclaringType -eq $Client.GetType() -and $_.Name -eq $Procedure}
                } else {
                ...
                # Loop over each method for the RPC interface
                        ...
                        for ($i = 0; $i -lt $Iterations; $i++) {
                            ...
                            try {
                                ...
                                if ($Blacklist -notcontains $ProcedureName) {
                                    ...
                                    # Procedure in blocklist continue with the next
                                    continue
                                }
